    ...
    <div class="alert-wrapper">
      <div class="alert-frame">
        ${img !== '' ? '<div class="alert-header ' + type + '-bg">' : '<div>'}
          ...
          ${img !== '' ? '<img class="alert-img" src="images/alertbox/' + type +  '.svg" />' : ''}
        </div>
...
const cuteToast = ({ type, title, message, timer = 5000,  vibrate = [], playSound = null }) => {
  return new Promise(resolve => {
      ...
      <div>
        <div class="toast-frame">
          <div class="toast-body">
            <img class="toast-body-img" src="images/alertbox/${type}.svg" />'
    ...
    if (toasts.length) {
      toasts[0].insertAdjacentHTML('afterend', templateContent);
    } else {
